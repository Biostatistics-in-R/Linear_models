...
This distirbution is still pretty weird, with a small amount of negative skew in the non-zero values and a good number of zeros as well. You could argue that this is evidence that there are really two classes of cricket: 'singers' and 'non-singers' and that it's not apporpriate to class them all together, but that's something for a different analysis. 
...
question("Which of the following statements qq-plot of residuals is correct?",
...
VIDEO ON CURVES IN LINEAR MODELS
...
You can see that the quadratic term is highly significant on the deletion test, indicating that a model without it has significantly less expalantory power. Has this fixed the curvature in the diagnostic plot?
